"""FastAPI server — exposes all Logico operations as a local HTTP API.
...
app = FastAPI(title="Logico", version="0.1.0", docs_url=None, redoc_url=None)
